...
echo "🔧 Starte AUREON ∞ SUPERVISOR PATCHING..."

# 1. Prüfe und erstelle das Chronik-Verzeichnis
CHRONIK_DIR="/root/AUREON/CHRONIK"
mkdir -p "$CHRONIK_DIR"

# 2. Patch für Python-Supervisor-Datei einfügen
SUPERVISOR_PY="/root/AUREON/aureon_supervisor_autointel.py"

cat << 'EOF' > "$SUPERVISOR_PY"
...
echo "🚀 Starte Supervisor-Testlauf:"
